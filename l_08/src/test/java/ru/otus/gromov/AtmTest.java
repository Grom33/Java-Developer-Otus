...
public class AtmTest {
    ...
    private static Map<Bill, Cassette> INITIALIZED_ATM_CASSETTES;
    ...
    static {
        INITIALIZED_ATM_CASSETTES = new HashMap<>();
        INITIALIZED_ATM_CASSETTES.put(Bill.FIVE_HUNDRED, new CassetteImpl(Bill.FIVE_HUNDRED, 1000));
        INITIALIZED_ATM_CASSETTES.put(Bill.HUNDRED, new CassetteImpl(Bill.HUNDRED, 1000));
        INITIALIZED_ATM_CASSETTES.put(Bill.THOUSAND, new CassetteImpl(Bill.THOUSAND, 1000));
        INITIALIZED_ATM_CASSETTES.put(Bill.FIVE_THOUSAND, new CassetteImpl(Bill.FIVE_THOUSAND, 1000));
    ...
    @Before
    public void setup() {
        ATM = new AtmImpl(1, INITIALIZED_ATM_CASSETTES);
    }
